#include "pch.h" // Препроцессорная директива для предкомпилированного заголовка
#include "CppUnitTest.h" // Заголовочный файл фреймворка модульного тестирования C++
#include <vector>
#include <algorithm>
